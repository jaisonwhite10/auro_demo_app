...
const TrendingItem = ({activeItem, item}) => {
  ...
  return (
    <Animatable.View className="mr-5" animation={activeItem === item.$id ? zoomIn : zoomOut} duration={500}>
      {play ? (
        // for whatever reason using item.video does not allow my videos to work might be a larger issue at play, but using this "https://www.w3schools.com/html/mov_bbb.mp4" works could be format issue or server issue.
        <Video 
